...
public class TestVenomUnitCard {
	...
	void testAttack() {
		...
		assertEquals(1,oppoUnit1.attackUnit(venomUnit1));
		assertEquals(0,venomUnit1.getHealth());
		
		assertEquals(3,oppoUnit1.attackUnit(venomUnit2));
		assertEquals(0,venomUnit2.getHealth());
		
		assertEquals(5,oppoUnit1.attackUnit(venomUnit3));
		assertEquals(0,venomUnit3.getHealth());
